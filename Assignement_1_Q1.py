# -*- coding: utf-8 -*-
"""
Created on Fri Sep  8 12:25:44 2023
...
# Function which gives Power, Thrust, CP, pn and pt for one configuration of omega and pitch
...
# Test 
# oneconfig_calculus(r_list, c_list, twist_list, thick_list, 10, 8.029*2*pi/60, 89.17, 3, 0)
...
plt.plot(lambda_list_glauert, cp_table_glauert[:,0], label = 'pitch = -4°')
plt.plot(lambda_list_glauert, cp_table_glauert[:,20], label = 'pitch = -2°')
plt.plot(lambda_list_glauert, cp_table_glauert[:,40], label = 'pitch = 0°')
plt.plot(lambda_list_glauert, cp_table_glauert[:,60], label = 'pitch = 2°')
plt.ylabel('CP')
plt.xlabel('lambda')
plt.legend()
plt.grid()
...
plt.plot(lambda_list_glauert, ct_table_glauert[:,0], label = 'pitch = -4°')
plt.plot(lambda_list_glauert, ct_table_glauert[:,20], label = 'pitch = -2°')
plt.plot(lambda_list_glauert, ct_table_glauert[:,40], label = 'pitch = 0°')
plt.plot(lambda_list_glauert, ct_table_glauert[:,60], label = 'pitch = 2°')
plt.ylabel('CT')
plt.xlabel('lambda')
plt.legend()
plt.grid()
...
# plt.plot(lambda_list_glauert, cp_table_glauert[:,0], label = 'pitch = -4°')
# plt.plot(lambda_list_glauert, cp_table_glauert[:,37], label = 'pitch = -0.2°')
# plt.plot(lambda_list_glauert, cp_table_glauert[:,40], label = 'pitch = 0,1°')
# plt.plot(lambda_list_glauert, cp_table_glauert[:,59], label = 'pitch = 2°')
# plt.plot(lambda_max_glauert, cp_max_glauert, marker="o", markersize=5, markeredgecolor="red", markerfacecolor="green")
# plt.ylabel('CP')
# plt.xlabel('lambda')
# plt.legend()
# plt.grid()
...
plt.plot(ct_table_glauert[:,0], cp_table_glauert[:,0], label = 'pitch = -4°')
plt.plot(ct_table_glauert[:,20], cp_table_glauert[:,20], label = 'pitch = -2°')
plt.plot(ct_table_glauert[:,40], cp_table_glauert[:,40], label = 'pitch = -0°')
plt.plot(ct_table_glauert[:,60], cp_table_glauert[:,60], label = 'pitch = 2°')
plt.ylabel('CP')
plt.xlabel('CT')
plt.legend()
plt.grid()
...
plt.plot(ct_table_glauert[0,:], cp_table_glauert[0,:], label = 'lambda = 5')
plt.plot(ct_table_glauert[10,:], cp_table_glauert[10,:], label = 'lambda = 6')
plt.plot(ct_table_glauert[20,:], cp_table_glauert[20,:], label = 'lambda = 7')
plt.plot(ct_table_glauert[40,:], cp_table_glauert[40,:], label = 'lambda = 9')
plt.ylabel('CP')
plt.xlabel('CT')
plt.legend()
plt.grid()
