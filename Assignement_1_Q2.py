# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 16:53:33 2023
...
def Cl_Cd_alpha_q2(V0, lambda_max, c, R, r, B, pitch_max, twist, thick) :
    ...
    a, aprim = a_glauert_algo(V0, omega, c, R, r, B, pitch_max, twist, thick)
    flow = flow_calculus(a, aprim, V0, omega, r)
    # Degrees to radians
    pitch = pitch_max * pi / 180
    twist = twist * pi / 180 
    alpha = alpha_calculus(flow, theta_calculus(pitch, twist))
    # alpha in radians -> we need it in degrees for the interpolation
...
""" Now we need a modified version of the a and aprim calculus algorithm """
...
# Algorithm to compute a and aprim alpha_max already in radians
...
print('Variation where we take Cl/Cd maximum')
